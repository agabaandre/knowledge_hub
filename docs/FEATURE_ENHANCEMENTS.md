...
This document summarizes recent platform enhancements for **administrators**, **contributors**, and **operators**. It complements the installation guide in [README.md](../README.md) and topic-specific docs linked from the [documentation index](#related-documentation).
...
| Document | Topic |
|----------|--------|
| [README.md](../README.md) | Install, installer, API index |
| [docs/DOCKER.md](DOCKER.md) | Container deployment |
| [docs/CONTENT_REQUEST_REFERRALS.md](CONTENT_REQUEST_REFERRALS.md) | Content request referrals |
| [docs/FORUM_ATTACHMENTS_PDF.md](FORUM_ATTACHMENTS_PDF.md) | Forum Office → PDF |
| [docs/KPI_INDICATORS_OWID.md](KPI_INDICATORS_OWID.md) | KPI / OWID indicators |
