        ...
        <div id="accordion">
            @foreach($regions as $region)
                ...
                $regionalResources = array_sum($resources);
                            @endphp
                            <div class="card w-100 mb-1"> <!-- Ensure card stretches with w-100 -->
                                <div class="card-header bg-white w-100" id="heading{{$region->id}}"> <!-- w-100 to stretch header -->
                                    <h5 class="mb-0">
                                        <button class="btn btn-link btn-block text-left collapsed" data-toggle="collapse" data-target="#collapse{{$region->id}}" aria-expanded="false" aria-controls="collapse{{$region->id}}" style="width: 100%;">
                                                                            ...
                                                                            <a href="{{ url('countries/details')}}?state={{$country->id}}">
                                                                                <div class="card">
                                                                                    <div class="card-body text-center">
                                                                                        ...
                                                                                        <p class="card-text"><small class="text-muted">{{$country}} Resources</small></p>
