            ...
            @foreach($regions as $region)
                ...
                <div class="card w-100 mb-1">
                    <div class="card-header bg-white" id="heading{{$region->id}}">
                        <h5 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" data-toggle="collapse" data-target="#collapse{{$region->id}}" aria-expanded="false" aria-controls="collapse{{$region->id}}">
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach($region_countries as $country)
                                    @php
                                        $country = (object) $country; // Correct casting syntax
                                    @endphp
