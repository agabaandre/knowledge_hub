        ...
        <div class="article_body_wrap">
            ...
            <div class="article_top_info">
                <ul class="article_middle_info">
                    <li><span class="text-bold text-red"><i class="lni lni-user mr-1"></i> {{ $forum->user->name }}</span></li><br>
    ...
    <!-- Blog Comment -->
        ...
        <div class="comment-area">
            <div class="all-comments">
                <h3 class="comments-title text-muted mt-3">{{ (count($forum->comments)>0)?count($forum->comments):'No '}} Engagements</h3>
            ...
            @auth
                ...
                @else
                <h5 class="text-center text-danger mt-5 mb-5"><i class="fa fa-info-circle"></i> You have to join before you can participate in the discussion</h5>
                ...
                @endif
            @else
                <h5 class="text-center text-danger mt-5 mb-5"><i class="fa fa-info-circle"></i> Only logged in users participate in discussions</h5>
            @endauth
