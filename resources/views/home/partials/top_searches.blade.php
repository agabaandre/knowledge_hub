               ...
               @foreach ($recent as $row)
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12" data-aos="zoom-in">
                      <div class="jbr-wrap text-left border rounded">
                          <div class="cats-box mlb-res rounded bg-white d-flex align-items-center px-3 py-3 top-searches-card">
                               <div class="cats-box rounded bg-white d-flex align-items-center top-searches-card" style="min-width:100%;">
                                   ...
                                   <!-- Image Section -->
                                   <div class="cats-box-image top-searches-image" style="width: 150px; height: 150px; flex-shrink: 0; margin-right: 1rem; border: 1px solid #e2e8f0; overflow: hidden; background: #f1f5f9; display: flex; align-items: center; justify-content: center;">
                                       <img src="{{ $image_link }}"
