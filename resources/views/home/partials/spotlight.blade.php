<div class="spotlight px-3 py-3 custom-bg"  style="background: linear-gradient(var(--theme-color-primary), rgba(0, 0, 0, 0.4)) !important;" style="background-color: linear-gradient(var(--theme-color-primary), rgba(0, 0, 0, 0.4)) !important; background-image: url({{settings()->spotlight_banner }});">
