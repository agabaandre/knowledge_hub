...
<div class="d-block mb-2 mt-3">
    ...
    @foreach($tags as $tag)
    <div  class="custom-row-item px-3 py-1 mr-1 mt-1 medium bg-{{ $colors[mt_rand(0,2)] }} rounded col-xs-6  col-sm-6  col-md-3  col-lg-3 text-center text-truncate" title="{{$tag->tag_text}}">
