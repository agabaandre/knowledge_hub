        ...
        <div class="row justify-content-center mb-4">
            <div class="col-12">
                <div class="sec_title position-relative text-center">
                    <h2 class="ft-bold mb-0 notranslate" style="color: #1e293b;" data-khub-i18n="home_sections.recommended">{{ \App\Support\UiLocaleLabels::homeSection('recommended') }}</h2>
                </div>
            </div>
        </div>
        <div class="row g-0" id="featured">
            @foreach ($featured as $row)
                ...
                <div class="col-12 col-md-6 mb-3 px-2 px-md-3 d-flex">
                    <div class="theme1-featured-card forum-post-card w-100 pub-card-file-type-corner-wrap">
