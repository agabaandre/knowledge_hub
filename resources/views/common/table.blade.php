<style>
    .table{background:#fff;border:1px solid #e2e8f0;border-radius:0;overflow:hidden}
    ...
    .dataTables_wrapper .dataTables_filter input{border:1px solid #e2e8f0;border-radius:0;padding:6px 10px}
    .dataTables_wrapper .dataTables_length select{border:1px solid #e2e8f0;border-radius:0;padding:6px 28px 6px 10px}
