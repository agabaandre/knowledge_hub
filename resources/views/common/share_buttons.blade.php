...
<a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text={{ $subject}}}}url={{ $link}}" target="_blank" rel="noopener" aria-label="Share on X">
  <div class="resp-sharing-button resp-sharing-button--black resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solidcircle">
...
<a class="resp-sharing-button__link" href="mailto:?subject={{ $subject}}&body={{ $link}}" target="_self" rel="noopener" aria-label="Share by E-Mail">
...
<a class="resp-sharing-button__link" href="whatsapp://send?text={{ $subject}} {{ $link}}" target="_blank" rel="noopener" aria-label="Share on WhatsApp">
