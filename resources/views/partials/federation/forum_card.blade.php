<div class="card border rounded mb-3 federation-forum-card">
    <div class="card-body py-3">
        ...
        <a href="{{ $forum->federation_source_url }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary mt-2">
            <i class="fa fa-external-link-alt me-1"></i>View on {{ $forum->federation_hub_name }}
        </a>
    </div>
</div>
