...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h3 class="card-title mb-0">New Feed</h3></div>
            <div class="card-body">
                <form action="{{ route('admin.rss_feeds.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="url" id="url" class="form-control" value="{{ old('url') }}" required placeholder="https://...">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="is_active">Active (include in weekly fetch)</label>
                        </div>
                    </div>
