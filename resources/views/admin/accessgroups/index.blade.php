...
<div class="row">
	<div class="card col-lg-12">
		<div class="card-header text-left">
			<h3 class="card-title float-left">{{ $title ?? 'Access Groups' }}</h3>
			 <hr>
		</div>
			...
			<form  class="container-fluid">
				  <div class="row">
				    ...
				    <div class="col-md-12 text-right">
					 <a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add Access Group</a>
					</div>
		...
		<div class="card-body text-left">
            ...
            <div class="py-2"> {{$access_groups->links() }}</div>

		</div>

	</div>

	@include('admin.accessgroups.partials.create-modal')
	<!-- Include edit-modal.php -->
	@include('admin.accessgroups.partials.edit-modal')
	<!-- Include delete-modal.php -->
	@include('admin.accessgroups.partials.delete-modal')
