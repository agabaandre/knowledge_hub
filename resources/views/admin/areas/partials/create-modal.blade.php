            ...
            <form id="createAreaForm" enctype="multipart/form-data" action="{{ route('areas.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="2" minlength="2" name="iso_code"
                            required>
                    </div>

                    <div class="form-group">
                        <label for="name">ISO 3 Code</label>
                        <input type="text" class="form-control" maxlength="3" minlength="3" name="iso3_code"
                            required>
                    </div>

                    <div class="form-group">
                        <label for="name">Knowledge Base URL</label>
                        <input type="text" class="form-control" name="base_url" required>
                    </div>

                    <div class="form-group">
                        <label for="name">Is App Supported</label>
                        <input type="checkbox" class="form-control" value="1" name="app_supported">
                    </div>
