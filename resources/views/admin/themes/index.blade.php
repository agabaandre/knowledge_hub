...
<div class="row">
	<div class="card col-lg-12">
		<div class="card-header text-left">
			<h3 class="card-title float-left">{{ $title ?? 'Thematic Area' }}</h3>
			 <hr>
		</div>
			...
			<form  class="container-fluid">
				  <div class="row">
				    ...
				    <div class="col-md-12 text-right">
					 <a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add Thematic Area</a>
					</div>
