...
<div class="row">
			...
			<form  class="container-fluid">
				  <div class="row">
				    ...
				    <div class="col-md-12 text-right">
					 <a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add COP</a>
					</div>
	...
	@include('admin.commsofpractice.partials.edit-modal')
