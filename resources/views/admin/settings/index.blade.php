            ...
            <div class="tab-content settings-content" id="settingsTabContent">
                ...
                <div class="tab-pane fade" id="advanced" role="tabpanel">
                    ...
                    @if(!empty($moodleFields) || !empty($frappeFields) || !empty($openEdxFields))
                        ...
                        <p class="settings-group-help mb-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="info-text">Env key: <code>MOODLE_API_URL</code></small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="info-text">Env key: <code>MOODLE_URL</code></small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="info-text">Leave blank to keep the current token. Env key: <code>MOODLE_API_TOKEN</code></small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <small class="info-text">Env key: <code>MOODLE_SYNC_ENABLED</code></small>
                                    </div>
                                </div>
                            </div>
                        </div>
