...
.nav-menu-social.kh-linkedin-nav li a {
    display: flex !important;
    padding: 0.3rem 0.35rem 0.15rem !important;
}

    /* Active state styling */
    .nav-menu:not(.kh-linkedin-nav) > li > a { color: #333; border-bottom: 2px solid transparent; }
    .nav-menu:not(.kh-linkedin-nav) > li.active > a,
    .nav-menu:not(.kh-linkedin-nav) > li > a:hover { color: var(--theme-color-primary, #119A48); border-bottom-color: var(--theme-color-primary, #119A48); }
    ...
    <div class="menu-container">
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper notranslate" style="transition-property: none;">
                <ul class="nav-menu kh-linkedin-nav">
                    @include('layouts.partials.nav_linkedin_legacy')
                    @include('partials.account.authlinks', ['class' => 'mobileonly'])
                </ul>

                <ul class="nav-menu nav-menu-social align-to-right kh-linkedin-nav">
