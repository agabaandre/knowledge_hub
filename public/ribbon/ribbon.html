        ...
        <div class="ribbon-bar gcui-ribbon-width">
                ...
                <ul>
                    <li id="clipboardgroup">
                        ...
                        <div class="gcui-ribbon-list">
                            ...
                            <div>
                                <button title="Copy" data-bind="attr: { title: res.ribbon.home.copy }" class="gcui-ribbon-copy"
                                    name="copy">
                                </button>
                            </div>
                        </div>
                    ...
                    <li id="fontgroup">
                        <div>
                            <div class="gcui-ribbon-list gcui-ribbon-fontfamily-parent">
                                <button id="font-family" title="Font Family" data-bind="attr: { title: res.ribbon.home.fontFamily }"
                                    name="font-family">Calibri</button>
                                <ul>
                                    <li>
                            ...
                            <div class="gcui-ribbon-list  gcui-ribbon-fontsize-parent">
                                <button title="Font Size" data-bind="attr: { title: res.ribbon.home.fontSize }" name="font-size"
                                    id="font-size">10
                                </button>
                                <ul>
                                    <li>
                        ...
                        <div class="clear-float">
                            <div class="gcui-ribbon-list">
                                ...
                                <label for="font-weight" name="font-weight" title="Bold" data-bind="attr: { title: res.ribbon.home.bold }"
                                    class="gcui-ribbon-bold"></label>

                                <input type="checkbox" id="font-italic" />
                                <label for="font-italic" name="font-italic" title="Italic" data-bind="attr: { title: res.ribbon.home.italic }"
                                    class="gcui-ribbon-italic"></label>

                                <input type="checkbox" id="font-underline" />
                                <label for="font-underline" name="font-underline" data-bind="attr: {title:res.ribbon.home.underline}"
                                    class="gcui-ribbon-underline"></label>

                                <input type="checkbox" id="font-double-underline" />
                                <label for="font-double-underline" name="font-double-underline" data-bind="attr: {title:res.ribbon.home.doubleUnderline}"
                                    class="gcui-ribbon-double-underline"></label>
                                <div class="gcui-ribbon-separator"></div>
                                <span>
                                    <button id="borders" title="Borders" data-bind="attr: { title: res.ribbon.home.border }"
                                        name="bottom-border" class="gcui-ribbon-bottomborder">
                                    </button>
                                    <ul>
                                        <li>
                                ...
                                <button id="backcolor-button" title="Background Color" data-bind="attr: { title: res.ribbon.home.backColor }"
                                    class="gcui-ribbon-bgcolor" name="backcolor"></button>
                                <button id="forecolor-button" title="Font Color" data-bind="attr: { title: res.ribbon.home.fontColor }"
                                    class="gcui-ribbon-forecolor" name="forecolor"></button>
                            </div>
                        </div>
                        <div>
                            <span data-bind="text: res.ribbon.home.fonts">Fonts</span>
                            <button title="Font" class="gcui-ribbon-indicatoricon" data-bind="attr: { title: res.ribbon.home.fonts }"
                                name="fontgroup">
                            </button>
                        </div>
                    </li>
                    <li id="alignmentgroup">
                        <div class="gcui-ribbon-list ui-buttonset">
                            <div>
                                <span class="gcui-ribbon-list">
                                    ...
                                    <label for="middle-align" name="middle-align" class="gcui-ribbon-middlealign" title="Middle Align"
                                        data-bind="attr: { title: res.ribbon.home.middleAlign }"></label>

                                    <input type="radio" name="vertical-align" id="bottom-align" />
                                    <label for="bottom-align" name="bottom-align" class="gcui-ribbon-bottomalign" title="Bottom Align"
                            ...
                            <div class="clear-float">
                                <span class="gcui-ribbon-list">
                                    ...
                                    <label for="left-algin" name="left-align" class="gcui-ribbon-leftalign" title="Left Align"
                                        data-bind="attr: { title: res.ribbon.home.leftAlign }"></label>

                                    <input type="radio" name="horizontal-align" id="center-align" />
                                    <label for="center-align" name="center-align" class="gcui-ribbon-centeralign" title="Center Align"
                                        data-bind="attr: { title: res.ribbon.home.centerAlign }"></label>

                                    <input type="radio" name="horizontal-align" id="right-align" />
                                    <label for="right-align" name="right-align" class="gcui-ribbon-rightalign" title="Right Align"
                                ...
                                <button title="Decrease Indent" data-bind="attr: { title: res.ribbon.home.decreaseIndent }"
                                    class="gcui-ribbon-decreaseindent" name="decrease-indent">
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <span>
                                    ...
                                    <label for="wrap-text" name="wrap-text" title="Wrap Text" data-bind="attr: { title: res.ribbon.home.wrapText }, text: res.ribbon.home.wrapText"
                            ...
                            <div>
                                <span>
                                    ...
                                    <label for="merge-center" name="merge-center" title="Merge & Center" data-bind="attr: { title: res.ribbon.home.mergeCenter }, text: res.ribbon.home.mergeCenter"
                                        class="gcui-ribbon-mergecenter">Merge & Center</label>
                                </span>
                                <span>
                        ...
                        <div>
                            ...
                            <button title="Alignment" class="gcui-ribbon-indicatoricon" data-bind="attr: { title: res.ribbon.home.alignment }"
                                name="aligngroup">
                            </button>
                        </div>
                    </li>
                    <li id="numbergroup">
                        <div>
                            <div class="gcui-ribbon-number-parent">
                                <button id="number-format" title="Number Format" data-bind="attr: { title: res.ribbon.home.numberFormat }, text: res.ribbon.home.general"
                        ...
                        <div>
                            ...
                            <button title="Comma Style" data-bind="attr: { title: res.ribbon.home.commaStyle }" class="gcui-ribbon-commastyle"
                                name="format-comma"></button>
                            <div class="gcui-ribbon-separator"></div>
                        ...
                        <div>
                            ...
                            <button title="Number" class="gcui-ribbon-indicatoricon" data-bind="attr: { title: res.ribbon.home.numbers }"
                                name="numbergroup">
                            </button>
                        </div>
                    </li>
                    <li id="celltypegroup">
                        <div class="gcui-ribbon-list">
                            <div>
                                ...
                                <button title="CheckBox CellType" data-bind="attr: { title: res.ribbon.home.checkboxCellType }"
                                    class="gcui-ribbon-checkboxcelltype" name="checkbox-celltype"></button>
                            </div>
                            <div>
                                <button title="ComboBox CellType" data-bind="attr: { title: res.ribbon.home.comboBoxCellType }"
                                    class="gcui-ribbon-comboboxcelltype" name="combobox-celltype"></button>
                                <button title="HyperLink CellType" data-bind="attr: { title: res.ribbon.home.hyperlinkCellType }"
                    ...
                    <li id="stylesgroup">
                        <button id="condition-format" title="Conditional Formatting" data-button-size="65px" data-bind="attr: { title: res.ribbon.home.conditionFormat1 }"
                            class="gcui-ribbon-bigbutton" name="conditional-format">
                            <span class="gcui-ribbon-conditionalformat"></span>
                            <span data-bind="text: res.ribbon.home.conditionFormat">Conditional Format</span>
                        </button>
                        <button title="Format as Table" data-button-size="85px" data-bind="attr: { title: res.ribbon.home.formatTable1 }"
                            class="gcui-ribbon-bigbutton" id="format-table-button" name="format-table">
                            <span class="gcui-ribbon-formattable"></span>
                            <span data-bind="text: res.ribbon.home.formatTable">Format Table</span>
                        </button>
                        <button title="Cell Styles" data-bind="attr: { title: res.cellStylesDialog.cellStyles }" class="gcui-ribbon-bigbutton"
                            id="cell-styles-button" name="cell-styles">
                    ...
                    <li id="cellsgroup">
                        <div class="gcui-ribbon-list">
                            <button id="insert-row-column" title="Insert" data-bind="attr: { title: res.ribbon.home.insert }"
                                class="gcui-ribbon-bigbutton" name="insert">
                        ...
                        <div class="gcui-ribbon-list">
                            ...
                            <button id="delete-row-column" title="Delete" data-bind="attr: { title: res.ribbon.home.Delete }"
                                class="gcui-ribbon-bigbutton" name="delete">
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button id="format-row-column" title="Format" data-bind="attr: { title: res.ribbon.home.format }"
                                    class="gcui-ribbon-bigbutton" name="format">
                    ...
                    <li id="editinggroup">
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Auto Sum" data-bind="attr: { title: res.ribbon.home.autoSum }, text: res.ribbon.home.autoSum"
                            ...
                            <div>
                                <div>
                                    <button title="Fill" data-bind="attr: { title: res.ribbon.home.fill }, text: res.ribbon.home.fill"
                            ...
                            <div>
                                <div>
                                    <button title="Clear" data-bind="attr: { title: res.ribbon.home.clear }, text: res.ribbon.home.clear"
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button id="sort-filter" title="Sort&Filter" data-bind="attr: { title: res.ribbon.home.sortFilter1 }"
            ...
            <div id="insertTab">
                <ul>
                    <li id="tables">
                        <div class="gcui-ribbon-list">
                            <button title="Insert Table" data-button-size="50px" data-bind="attr: { title: res.ribbon.insert.insertTable }"
                                class="gcui-ribbon-bigbutton" name="insert-table">
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button title="Insert Chart" data-button-size="50px" data-bind="attr: { title: res.ribbon.insert.insertChart }"
                                class="gcui-ribbon-bigbutton" name="insert-chart">
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button id="insert-Shapes" title="Insert Shapes" data-button-size="50px" data-bind="attr: { title: res.ribbon.insert.insertShapes }"
                                class="gcui-ribbon-bigbutton" name="insert-shapes">
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button title="Insert Barcode" data-button-size="50px" data-bind="attr: { title: res.ribbon.insert.insertBarcode }"
                                class="gcui-ribbon-bigbutton" name="insert-barcode">
                    ...
                    <li id="sparklines">
                        <button title="Insert Line Sparkline" data-bind="attr: { title: res.ribbon.insert.insertLineSparkline }"
                        ...
                        <button title="Insert Column Sparkline" data-bind="attr: { title: res.ribbon.insert.insertColumnSparkline }"
                        ...
                        <button title="Insert Win/Loss Sparkline" data-bind="attr: { title: res.ribbon.insert.insertWinlossSparkline }"
                        ...
                        <button title="Insert Area Sparkline" data-bind="attr: { title: res.ribbon.insert.insertAreaSparkline }"
                        ...
                        <button title="Insert Scatter Sparkline" data-bind="attr: { title: res.ribbon.insert.insertScatterSparkline }"
                        ...
                        <button title="Insert Spread Sparkline" data-bind="attr: {title:res.ribbon.insert.insertSpreadSparkline}"
                        ...
                        <button title="Insert Stacked Sparkline" data-bind="attr: {title:res.ribbon.insert.insertStackedSparkline}"
                        ...
                        <button title="Insert BoxPlot Sparkline" data-bind="attr: { title: res.ribbon.insert.insertBoxPlotSparkline }"
                        ...
                        <button title="Insert Cascade Sparkline" data-bind="attr: { title: res.ribbon.insert.insertCascadeSparkline }"
                        ...
                        <button title="Insert Pareto Sparkline" data-bind="attr: {title:res.ribbon.insert.insertParetoSparkline}"
                        ...
                        <button title="Insert Bullet Sparkline" data-bind="attr: { title: res.ribbon.insert.insertBulletSparkline }"
                        ...
                        <button title="Insert Hbar Sparkline" data-bind="attr: { title: res.ribbon.insert.insertHbarSparkline }"
                        ...
                        <button title="Insert Vbar Sparkline" data-bind="attr: { title: res.ribbon.insert.insertVbarSparkline }"
                        ...
                        <button title="Insert Variance Sparkline" data-bind="attr: { title: res.ribbon.insert.insertVariSparkline }"
                        ...
                        <button title="Insert Month Sparkline" data-bind="attr: { title: res.ribbon.insert.insertMonthSparkline }"
                        ...
                        <button title="Insert Year Sparkline" data-bind="attr: { title: res.ribbon.insert.insertYearSparkline }"
            ...
            <div id="dataTab">
                <ul>
                    <li id="sortAndFilter">
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Sort A to Z" data-bind="attr: { title: res.ribbon.data.sortAtoZ }" class="gcui-ribbon-sortAZ"
                                    name="sort-AZ">
                                </button>
                            </div>
                            <div>
                                <button title="Sort Z to A" data-bind="attr: { title: res.ribbon.data.sortZtoA }" class="gcui-ribbon-sortZA"
                                    name="sort-ZA">
                                </button>
                            </div>
                        </div>
                        <div class="gcui-ribbon-list">
                            <button title="Sort" data-bind="attr: { title: res.ribbon.data.customSort }" class="gcui-ribbon-bigbutton"
                                name="custom-sort">
                        ...
                        <div class="gcui-ribbon-longseparator"></div>
                        <div class="gcui-ribbon-list">
                            <button title="Filter" data-bind="attr: { title: res.ribbon.data.filter }" data-button-size="61px"
                                class="gcui-ribbon-bigbutton" name="set-filter">
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <button title="Outline" data-bind="attr: { title: res.ribbon.data.outline }" class="gcui-ribbon-indicatoricon"
                    ...
                    <li>
                        ...
                        <div class="gcui-ribbon-list" id="schemaActionList">
                            <div>
                                <button title="Load schema to get a tree view" data-bind="attr: { title: res.ribbon.data.loadSchemaTitle }"
                                    name="loadSchema">
                            ...
                            <div>
                                <button title="Save schema into a json file" data-bind="attr: { title: res.ribbon.data.saveSchemaTitle }"
                                    name="saveSchema">
                            ...
                            <div>
                                <button title="Clear BindingPath" data-bind="attr: { title: res.ribbon.data.clearBindingPath }"
                        ...
                        <div class="gcui-ribbon-longseparator"></div>
                        <div class="gcui-ribbon-list">
                            <button title="Automatically Generate Data Label" data-bind="attr: { title: res.ribbon.data.autoGenerateLabelTip }, text: res.ribbon.data.autoGenerateLabel"
            ...
            <div id="viewTab">
                <ul>
                    <li>
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Show/Hide RowHeader" data-bind="attr: { title: res.ribbon.view.rowHeaderTip }, text: res.ribbon.view.rowHeader"
                                    id="showhide-rowheader" name="showhide-rowheader" class="gcui-ribbon-checked">Row
                                    Header
                                </button>
                            </div>
                            <div>
                                <button title="Show/Hide ColumnHeader" data-bind="attr: { title: res.ribbon.view.columnHeaderTip }, text: res.ribbon.view.columnHeader"
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Show/Hide Vertical Gridline" data-bind="attr: { title: res.ribbon.view.verticalGridlineTip }, text: res.ribbon.view.verticalGridline"
                            ...
                            <div>
                                <button title="Show/Hide Horizontal Gridline" data-bind="attr: { title: res.ribbon.view.horizontalGridlineTip }, text: res.ribbon.view.horizontalGridline"
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Show/Hide TabStrip" data-bind="attr: { title: res.ribbon.view.tabStripTip }, text: res.ribbon.view.tabStrip"
                                    id="showhide-tabstrip" name="showhide-tabstrip" class="gcui-ribbon-checked">TabStrip
                                </button>
                            </div>

                            <div>
                                <button title="Show/Hide NewTab" data-bind="attr: { title: res.ribbon.view.newTabTip }, text: res.ribbon.view.newTab"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button id="freeze-panes" title="Freeze Panes" data-bind="attr: { title: res.ribbon.view.freezePane1 }"
                                class="gcui-ribbon-bigbutton" data-button-size="72px" name="freeze-panes">
            ...
            <div id="sparklineTab">
                <ul>
                    <li>
                        ...
                        <label for="sparkline-type-line" name="sparkline-type-line" class="gcui-ribbon-sparkline-line gcui-ribbon-bigbutton"
                            title="Line Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.lineTip }, text: res.ribbon.sparkLineDesign.line">Line</label>

                        <input type="radio" name="sparkline-type" id="sparkline-type-column" />
                        <label for="sparkline-type-column" name="sparkline-type-column" class="gcui-ribbon-sparkline-column gcui-ribbon-bigbutton"
                            title="Column Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.columnTip }, text: res.ribbon.sparkLineDesign.column">Column</label>

                        <input type="radio" name="sparkline-type" id="sparkline-type-winloss" />
                        <label for="sparkline-type-winloss" name="sparkline-type-winloss" class="gcui-ribbon-sparkline-winloss gcui-ribbon-bigbutton"
                            title="Win/Loss Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.winLossTip }, text: res.ribbon.sparkLineDesign.winLoss">Win/Loss</label>
                        <div data-bind="text: res.ribbon.sparkLineDesign.type">Type</div>
                    </li>
                    <li>
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Toggle Sparkline High Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.highPointTip }, text: res.ribbon.sparkLineDesign.highPoint"
                                    id="sparkline-high-point" name="sparkline-high-point" class="gcui-ribbon-unchecked">
                                    High Point
                                </button>
                            </div>
                            <div>
                                <button title="Toggle Sparkline Low Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.lowPointTip }, text: res.ribbon.sparkLineDesign.lowPoint"
                                    id="sparkline-low-point" name="sparkline-low-point" class="gcui-ribbon-unchecked">
                                    Low Point
                                </button>
                            </div>
                            <div>
                                <button title="Toggle Sparkline Negative Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.negativePointTip }, text: res.ribbon.sparkLineDesign.negativePoint"
                                    id="sparkline-negative-point" name="sparkline-negative-point" class="gcui-ribbon-unchecked">Negative
                                    Points
                                </button>
                            </div>
                        </div>
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Toggle Sparkline First Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.firstPointTip }, text: res.ribbon.sparkLineDesign.firstPoint"
                                    id="sparkline-first-point" name="sparkline-first-point" class="gcui-ribbon-unchecked">First
                                    Point
                                </button>
                            </div>
                            <div>
                                <button title="Toggle Sparkline Last Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.lastPointTip }, text: res.ribbon.sparkLineDesign.lastPoint"
                                    id="sparkline-last-point" name="sparkline-last-point" class="gcui-ribbon-unchecked">
                                    Last Point
                                </button>
                            </div>
                            <div>
                                <button title="Toggle Sparkline Market Point" data-bind="attr: { title: res.ribbon.sparkLineDesign.markersTip }, text: res.ribbon.sparkLineDesign.markers"
                                    id="sparkline-marker-point" name="sparkline-marker-point" class="gcui-ribbon-unchecked">Markers
                                </button>
                            </div>
                        </div>
                    ...
                    <li>
                        <div>
                            <button title="Sparkline Color" data-bind="attr: { title: res.ribbon.sparkLineDesign.sparklineColor }"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Group Selected Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.groupTip }"
                            ...
                            <div>
                                <button title="UnGroup Selected Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.unGroupTip }"
                            ...
                            <div>
                                <div>
                                    <button title="Clear Selected Sparkline" data-bind="attr: { title: res.ribbon.sparkLineDesign.clearSparkline }, text: res.ribbon.sparkLineDesign.clear"
                                    ...
                                    <span>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <button name="sparkline-clear-group" title="Clear Selected Sparkline Groups"
            ...
            <div id="tableTab">
                <ul>
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Header Row" data-bind="attr: { title: res.ribbon.tableDesign.headerRow }, text: res.ribbon.tableDesign.headerRow"
                                    id="table-header-row" name="table-header-row" class="gcui-ribbon-checked">Header
                                    Row
                                </button>
                            </div>
                            <div>
                                <button title="Total Row" data-bind="attr: { title: res.ribbon.tableDesign.totalRow }, text: res.ribbon.tableDesign.totalRow"
                                    id="table-total-row" name="table-total-row" class="gcui-ribbon-checked">Total Row
                                </button>
                            </div>
                            <div>
                                <button title="Banded Rows" data-bind="attr: { title: res.ribbon.tableDesign.bandedRows }, text: res.ribbon.tableDesign.bandedRows"
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="First Column" data-bind="attr: { title: res.ribbon.tableDesign.firstColumn }, text: res.ribbon.tableDesign.firstColumn"
                            ...
                            <div>
                                <button title="Last Column" data-bind="attr: { title: res.ribbon.tableDesign.lastColumn }, text: res.ribbon.tableDesign.lastColumn"
                                    id="table-last-column" name="table-last-column" class="gcui-ribbon-checked">Last
                                    Column
                                </button>
                            </div>
                            <div>
                                <button title="Banded Columns" data-bind="attr: { title: res.ribbon.tableDesign.bandedColumns }, text: res.ribbon.tableDesign.bandedColumns"
                        ...
                        <div class="gcui-ribbon-list">
                            <div>
                                <button title="Filter Button" data-bind="attr: { title: res.ribbon.tableDesign.filterButton}, text: res.ribbon.tableDesign.filterButton"
                    ...
                    <li>
                        <button title="Table Styles" data-bind="attr: { title: res.ribbon.tableDesign.tableStyle }" id="table-styles-button"
                            class="gcui-ribbon-bigbutton" name="table-styles">
                ...
                <ul>
                    <li>
                        <div class="gcui-ribbon-list">
                            ...
                            <div>
                                <input type="text" class="slicer-caption-name" size="16" maxlength="255" title="Slicer Caption"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <div title="Column" data-bind="attr: { title: res.ribbon.slicerOptions.columns }">
                                <button data-bind="text: res.ribbon.slicerOptions.columnsShow" class="slicer-ribbon-column gcui-ribbon-slicerbigbutton"
                                    data-button-size="57px">
                                    Columns:
                                </button>
                                <span>
                            ...
                            <div title="Height" data-bind="attr: { title: res.ribbon.slicerOptions.height }">
                                <button data-bind="text: res.ribbon.slicerOptions.heightShow" class="slicer-ribbon-height gcui-ribbon-slicerbigbutton"
                                    data-button-size="57px">
                                    Height:
                                </button>
                                <span>
                            ...
                            <div title="Width" data-bind="attr: { title: res.ribbon.slicerOptions.width }">
                                <button data-bind="text: res.ribbon.slicerOptions.widthShow" class="slicer-ribbon-width gcui-ribbon-slicerbigbutton"
                                    data-button-size="57px">
                                    Width:
                                </button>
                                <span>
            ...
            <div id="chartTab">
                <ul>
                    <li>
                        <div class="gcui-ribbon-list">
                            <button id="add-chart-element" title="Add Chart Element" data-bind="attr: { title: res.ribbon.chartDesign.addChartElement1 }"
                        ...
                        <div class="gcui-ribbon-list">
                            <button id="quick-layout" title="Quick Layout" data-bind="attr: { title: res.ribbon.chartDesign.quickLayout }"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button id="change-colors" title="Change Colors" data-bind="attr: { title: res.ribbon.chartDesign.changeColors }"
                        ...
                        <div class="gcui-ribbon-list">
                            <button id="chart-styles" title="Change Styles" data-bind="attr: { title: res.ribbon.chartDesign.chartStyles }"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button title="Switch Row Column" data-bind="attr: { title: res.ribbon.chartDesign.switchRowColumn }"
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button title="Change Chart Type" data-bind="attr: { title: res.ribbon.chartDesign.changeChartType }"
            ...
            <div id="shapeTab">
                <ul>
                    <li>
                        ...
                        <div class="gcui-ribbon-list">
                            <button id="change-shape-type" title="Change Shape Type" data-bind="attr: { title: res.ribbon.shapeDesign.changeShapeType}"
                                class="gcui-ribbon-bigbutton" data-button-size="70px" name="change-shape-type">
                    ...
                    <li>
                        <div class="gcui-ribbon-list">
                            <button id="rotate-shape-button" title="Rotate" data-bind="attr: { title: res.ribbon.shapeDesign.rotate }"
                                class="gcui-ribbon-bigbutton" data-button-size="70px" name="rotate-shape-button">
                    ...
                    <li class='gcui-ribbon-group-special'>
                        <div class="gcui-ribbon-list">
                            <button id="group-shape-button" title="Group" data-bind="attr: { title: res.ribbon.shapeDesign.group}"
                                class="gcui-ribbon-bigbutton" data-button-size="70px" name="group-shape-button">
            ...
            <ul id="condition-format-popup-menu" class="hidden ui-helper-reset ui-helper-clearfix ui-corner-all gcui-ribbon-dropdown">
                ...
                <li class="ui-corner-all">
                    <button name="new-rule" class="ui-button ui-widget ui-state-default ui-button-text-icon-primary">
                        ...
                        <span class="ui-button-text-small" data-bind="text: res.conditionalFormat.newRule">New Rule...</span>
                    </button>
                </li>
                <li class="ui-corner-all">
        ...
        <div id="cell-styles-popup" class="designer-cell-styles hidden">
            ...
            <div id="cellstyle-menu-container">
                <ul class="cellstyle-menu hidden">
                    <li class="cellstyle-modify" id="cellstyle-modify"><a href="#"><span class="cellstyle-icon-empty"></span><span
                                class="cellstyle-menu-text" data-bind="text: res.cellStyleContextMenu.modify"></span></a>
                    </li>
                    <li class="cellstyle-delete" id="cellstyle-delete"><a href="#"><span class="cellstyle-icon-empty"></span><span
                                class="cellstyle-menu-text" data-bind="text: res.cellStyleContextMenu.delete"></span></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="ss" style="height: 400px; border: solid gray 1px;">
    </div>
