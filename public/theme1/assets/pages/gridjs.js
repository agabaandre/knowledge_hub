document.addEventListener("DOMContentLoaded", () => {
   ...
   if (window.location.hostname)
      relativeTo = window.location.pathname.replace(/^\/.*?\/|.*\/.*$/g, "../");
   ...
   new gridjs.Grid({
      ...
      columns: [
         ...
         "Name",
         {
            ...
            formatter: (cell) =>
               gridjs.html(
                  `<span class="text-body text-nowrap"><i class="psi-clock text-body-secondary align-middle me-2"></i>${cell}</span>`
               ),
         },
         "Amount",
         {
            ...
            formatter: (cell) => {
               ...
               return gridjs.html(
                  `<span class="d-block rounded fw-bold text-nowrap text-center text-${bgColor} px-3">${cell}</span>`
               );
            },
         },
         "Membership",
