document.addEventListener("DOMContentLoaded", () => {
   ...
   // Resizable Columns
   // ---------------------------------------------------------------------------------
   const tabulatorResizableColumns = new Tabulator(
      "#_dm-tabulatorResizableColumns",
      {
         data: simpleData,
         layout: "fitColumns",
         columns: [
   ...
   // Formatting data
   // ---------------------------------------------------------------------------------
   const questionIcon = () => '<i class="psi-question fs-5"></i>';
   ...
   document
      .getElementById("_dm-filterField")
      .addEventListener("change", updateFilter);
   document
      .getElementById("_dm-filterType")
      .addEventListener("change", updateFilter);
   document
      .getElementById("_dm-filterValue")
