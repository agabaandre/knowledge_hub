 <div id="google_translate_element" style="display: none;"></div>
    <select class="selectpicker" data-width="fit" onchange="translateLanguage(this.value);" style="border:#FFF;" com>
        ...
        <option data-content='<span class="flag-icon flag-icon-pt"></span> Portuguese' value="Portuguese">Portuguese
        </option>
        <option data-content='<span class="flag-icon flag-icon-pt"></span> Spanish' value="Spanish">Spanish</option>
          <option data-content='<span class="flag-icon flag-icon-pt"></span> Swahili' value="Swahili">Swahili</option>
