<div class="row">
	...
	<div class="card col-lg-12">
		<div class="card-header text-left">
			...
			<a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add Sub Theme</a>
		</div>
		...
		<div class="card-body text-left">
			<table class="table table-striped">
				...
				<?php foreach ($subthemes as $row) : ?>
					<tr>
						<td width="5%"><i class="fa <?php echo $row->icon; ?> fa-2x text-muted"></i></td>
