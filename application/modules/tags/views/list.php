<div class="row">
	...
	<div class="card col-lg-12">
		<div class="card-header text-left">
			...
			<a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add New Tag</a>
		</div>
			...
			<table class="table table-striped">
				...
				<?php foreach ($tags as $row) : ?>
					<tr>
						...
						<td>
							<a href="#" data-id="<?php echo $row->id; ?>" data-tag="<?php echo $row->tag_text; ?>" data-toggle="modal" data-target="#edit-tag-modal" class="text-success"><i class="fa fa-edit"></i> Edit</a>
						</td>
