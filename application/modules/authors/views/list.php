	...
	<div class="card-header text-left">
	 ...
	 <div class="card-body text-left">
		...
		<?php foreach ($authors as $author): ?>
		     <tr>
				<td width="5%"><i class="fa fa-user text-muted"></i></td>
				<td><?php echo $author->name; ?></td>
				<td><?php echo $author->address; ?></td>
				<td><?php echo $author->telephone; ?></td>
				<td><?php echo $author->email; ?></td>
				<td><a href="#edit<?php echo $author->id; ?>"><i class="fa fa-edit"></i> Edit</td>
				<td><a href="javascript:void(0);" onclick="openDeleteModal(<?php echo $author->id; ?>)" class="text-danger"><i class="fa fa-trash"></i> Delete</td>
			 </tr>
		<?php endforeach; ?>
		</table>
