<div class="row">
	...
	<div class="card-header text-left">
		...
		<a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa fa-plus"></i> Add Geoghraphical Area</a>
	 </div>
