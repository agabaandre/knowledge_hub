<div class="row">
	...
	<div class="card-header text-left">
		...
		<a href="#create-modal" data-toggle="modal" class="btn btn-outline-success float-right"><i class="fa file-plus"></i> Add Publication</a>
	 </div>
	 ...
	 <div class="card-body text-left">
		...
		<?php foreach ($publications as $row): ?>
		     <tr>
				<td width="5%"><i class="fa <?php echo $row->file_type->icon; ?> fa-2x text-muted"></i></td>
				<td>
					<?php echo truncate($row->description,100); ?>
					<p><a href="<?php echo $row->publication; ?>" target="_blank">View Publication</a><p>
				</td>
