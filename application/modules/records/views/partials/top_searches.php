									...
									<div class="jbr-wrap text-left border rounded">
										<div class="cats-box mlb-res rounded bg-white d-flex align-items-center px-3 py-3">
											<div class="cats-box rounded bg-white d-flex align-items-center" style="min-width:75%;">
												<div class="text-center"><a href="<?php echo base_url("records/show/") . $row->id; ?>"><img src="<?php echo base_url(); ?>assets/images/icons/author.png" class="img-fluid" width="55" alt=""></a></div>
												<div class="cats-box-caption">
													<h4 class="fs-md mb-0 ft-medium"><a href="<?php echo base_url("records/show/") . $row->id; ?>"><?php echo truncate($row->title, 50); ?></a></h4>
													<div class="d-block mb-2 position-relative" >
													  <p class="text-nothern p-0"><a href="<?php echo base_url("records/show/") . $row->id; ?>"><?php echo nl2br(truncate($row->description,60)); ?></a></p>
														...
														<span class="text-muted medium d-block mt-1">
														    ...
														    <span><span class="mr-1 ml-2 text-muted d-inline "
																	...
																	data-bs-placement="bottom" aria-expanded="false" aria-controls="comments<?php echo $i; ?>"><i class="fa fa-comments"></i> <?php echo count($row->comments); ?> Comments</span></span>
															<?php if(!is_guest()): ?>
