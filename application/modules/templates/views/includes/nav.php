						...
						<ul class="horizontalMenu-list">
							...
							<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="bx bx-box menu-icon"></i> Advanced UI <i class="fe fe-chevron-down horizontal-icon"></i></a>
								<ul class="sub-menu">
									...
									<li aria-haspopup="true"><a href="cookies.html" class="slide-item">cookies</a></li>
								</ul>
							</li>
							...
							<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="bx bx-pie-chart-alt menu-icon"></i> Charts <span class="badge badge-danger horizontal-badge">5</span><i class="fe fe-chevron-down horizontal-icon"></i></a>
								<ul class="sub-menu">
							...
							<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="bx bxs-edit menu-icon"></i> Utilities <i class="fe fe-chevron-down horizontal-icon"></i></a>
								<ul class="sub-menu">
							...
							<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="bx bx-notepad menu-icon"></i> Pages <i class="fe fe-chevron-down horizontal-icon"></i></a>
								<ul class="sub-menu">
									...
									<li aria-haspopup="true"><a href="account-setting.html" class="slide-item">Account-setting</a></li>
									<li aria-haspopup="true"><a href="page-session.html" class="slide-item">Page-session</a></li>
									<li aria-haspopup="true" class="sub-menu-sub"><a href="#">Mail</a>
										<ul class="sub-menu">
											...
											<li aria-haspopup="true"><a href="scrumboard.html" class="slide-item">Scrumboard</a></li>

										</ul>
									</li>
									<li aria-haspopup="true" class="sub-menu-sub "><a href="#">Contacts</a>
										<ul class="sub-menu">
											<li aria-haspopup="true"><a href="contacts.html" class="slide-item">Contacts</a></li>
											<li aria-haspopup="true"><a href="contacts-one.html" class="slide-item">Contacts-List</a></li>
											<li aria-haspopup="true"><a href="contacts-two.html" class="slide-item">Contacts-Grid</a></li>
										</ul>
									</li>
									<li aria-haspopup="true" class="sub-menu-sub "><a href="#">Forms</a>
										<ul class="sub-menu">
											...
											<li aria-haspopup="true"><a href="form-element-sizes.html" class="slide-item">Form Elements Size</a></li>
									...
									<li aria-haspopup="true" class="sub-menu-sub "><a href="#">Invoice</a>
										<ul class="sub-menu">
											...
											<li aria-haspopup="true"><a href="invoice2.html" class="slide-item">Invoice2</a></li>
										</ul>
									</li>
							...
							<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="bx bx-store menu-icon"></i> E-Commerce <span class="badge badge-pink horizontal-badge">3</span><i class="fe fe-chevron-down horizontal-icon"></i></a>
								<ul class="sub-menu">
									...
									<li aria-haspopup="true"><a href="product-whishlist.html" class="slide-item">Whishlist</a></li>
									<li aria-haspopup="true"><a href="product-cart.html" class="slide-item">Shopping Cart</a></li>
									<li aria-haspopup="true"><a href="product-invoice.html" class="slide-item">Product-invoice</a></li>
								</ul>
							</li>
