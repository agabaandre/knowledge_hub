...
class MeApiController extends Controller
{
     ...
     *                 @OA\Property(property="my_forums", type="string", example="/api/forums/me"),
     ...
     *             @OA\Property(property="forums", type="object", description="First page of forums you joined (`GET /api/forums/me` or `GET /api/me/forums`)"),
     ...
     *     description="Paginated list of live, approved forums you are subscribed to (`forum_subscriptions`). Same as **`GET /api/forums/me`**. Use `page_size` (1–50) and optional `term` search.",
