"use client";
import UserSettingsDropdown from "@/components/dashboard/student/student-settings/UserSettingsDropdown";
import React, { useState } from "react";

const InstructorUploadPhotoMain = () => {
    // Default image state
...
export default InstructorUploadPhotoMain;
