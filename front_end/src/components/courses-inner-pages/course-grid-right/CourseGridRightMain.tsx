...
const CourseGridRightMain = () => {
    const { toggleOpen } = useGlobalContext();
    const [instructors, setInstructors] = useState<Instructor[]>(instructorsFilterDataTwo.slice(0, 5));
    ...
    return (
        <>
            <Breadcrumbs breadcrumbTitle='Course Grid Right' />
...
export default CourseGridRightMain;