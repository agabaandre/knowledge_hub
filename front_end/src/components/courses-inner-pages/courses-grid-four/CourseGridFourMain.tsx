...
import CourseGridFourCard from './CourseGridFourCard';
import useGlobalContext from '@/hooks/useContexts';

const CourseGridFourMain = () => {
    const { toggleOpen } = useGlobalContext();
    return (
        <>
            <Breadcrumbs breadcrumbTitle='Course Grid Style 04' />
            ...
            <section className="bd-course-grid-area section-space">
                <div className="container">
                    ...
                    <div className="row g-30">
                        {
                            coursesData.slice(59, 68).map((item, index) => (
                                <CourseGridFourCard course={item} key={index} />
                            ))
                        }
                    </div>
...
export default CourseGridFourMain;