...
const   RenderTextContentThree = (item: ICourse) => {
        ...
        if (item.courseTextContentStyle) {
            return (
                <div className="bd-course-text-content">
                    ...
                    <div className={`text-1 fs-50 ${item.spacingClass} text-white ${item.latterUppercase == true ? "uppercase":""}`}>{item.smallText}</div>
                    <div className={`text-1 ${item.FontSizeClass? item.FontSizeClass :"fs-50"} ${item.spacingClass} text-white ${item.latterUppercase == true ? "uppercase":""}`}>{item.smallTextThree}</div>
                </div>
            );
        } else {
            return (
...
export default RenderTextContentThree;