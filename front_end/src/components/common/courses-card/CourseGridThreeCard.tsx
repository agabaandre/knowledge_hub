...
import RenderTextContentTwo from '../../courses-inner-pages/course-grid-three/RenderTextContentTwo';
import GetRating from '../GetRating';

const CourseGridThreeCard = ({ course }: ICourseProps) => {
    return (
        <>
            <div className="bd-course-wrapper style-two">
                <Link href={`/courses/course-details/${course.id}`} className="bd-course-thumb-wrapper bd-course-thumb-style-three p-relative">
                    <div className="bd-course-thumb-bg"><Image src={course.image} alt="images" />
                    </div>
                    <div className="bd-course-instructor">{course.instructorImage && <Image src={course.instructorImage} alt="instructor" />}</div>
                    <div className="bd-course-logo">{course.shape && <Image src={course.shape} alt="logo" />}</div>
                    {RenderTextContentTwo(course)}
...
export default CourseGridThreeCard;