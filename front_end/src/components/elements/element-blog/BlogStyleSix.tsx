            ...
            <section className="bd-elements-blog section-space-bottom">
                <div className="container">
                            ...
                            <div className="bd-elements-section-wrapper section-title-space text-center">
                                <div className="bd-elements-line">
                                    ...
                                    <div className="bd-elements-title-wrapper">
                                        <h2 className="bd-elements-title small">Blog Style 06</h2>
                                    </div>
                    ...
                    <div className="row gy-30">
                        {
                            elementBlogData.slice(14, 16).map((item) => (
                                <div className="col-xl-6 col-lg-12" key={item.id}>
                                    <article className="bd-blog-wrapper style-six">
                                        <div className="bd-blog-thumb">
                                            <Link href="#"><Image src={item.image} alt="img" priority/></Link>
                                        </div>
                                        <div className="bd-blog-content">
                                            ...
                                            <h5 className="blog-title mb-20 underline"><Link href="#">{item.title}</Link></h5>
