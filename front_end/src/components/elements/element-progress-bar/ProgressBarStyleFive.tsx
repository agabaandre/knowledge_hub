...
const ProgressBarStyleFive = () => {
    return (
        <>
            {/* -- progress-bar style 05 start -- */}
                ...
                <div className="container">
                            ...
                            <div className="bd-elements-section-wrapper section-title-space text-center">
                                <div className="bd-elements-line">
                                    ...
                                    <div className="bd-elements-title-wrapper">
                                        <h2 className="bd-elements-title small">Progress Bar Style 05</h2>
                                    </div>
                    ...
                    <div className="row gy-30 justify-content-center">
                        <div className="col-xl-8">
                            <div className="bd-progress-wrapper progress-style-4">
            ...
            {/* -- progress-bar style 05 end -- */}
        </>
    );
};

export default ProgressBarStyleFive;