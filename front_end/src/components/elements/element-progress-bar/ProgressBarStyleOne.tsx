...
const ProgressBarStyleOne = () => {
    return (
        <>
            {/* -- progress-bar style 01 start -- */}
            <section className="bd-elements-progress-bar section-space">
                            ...
                            <div className="bd-elements-section-wrapper section-title-space text-center">
                                <div className="bd-elements-line">
                                    ...
                                    <div className="bd-elements-title-wrapper">
                                        <h2 className="bd-elements-title small">Progress Bar Style 01</h2>
                                    </div>
