        ...
        <section className="bd-elements-course section-space primary-bg">
            <div className="container">
                        ...
                        <div className="bd-elements-section-wrapper section-title-space text-center">
                            <div className="bd-elements-line">
                                ...
                                <div className="bd-elements-title-wrapper">
                                    <h2 className="bd-elements-title small">Course Style 13</h2>
                                </div>
                ...
                <div className="row gy-30">
                    {elementCoursesData.slice(26, 28).map((course, index) => (
                        <div className="col-xl-6 col-lg-6 col-md-6" key={index}>
                            <div className="bd-course-wrapper style-eleven white-bg">
...
export default CourseStyleThirteen;
