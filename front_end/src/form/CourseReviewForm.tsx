                ...
                <div className="row gy-30">
                    ...
                    <div className="col-xxl-12">
                        ...
                        <div className="checkbox-option">
                            ...
                            <label htmlFor="course-check-1">Save my name, email, and website in this browser for
                                the next time I comment.</label>
                        </div>
                    </div>
                    <div className="col-xxl-12">
                        <div className="bd-postbox-comment-btn">
                            <button type="submit" className="bd-btn btn-outline-primary">Submit Review</button>
                        </div>
                    </div>
                </div>
            </form>
