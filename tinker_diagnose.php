...
$out('1. Search page links: Open DevTools (F12) -> Console. Click "Read more" or "Khub AI". If nothing happens, check for JS errors and that the link href is correct.');
$out('2. Khub AI: On a resource detail page, click "Khub AI". If modal does not open, check Console for errors and that openPdfChat is defined (type: typeof openPdfChat).');
