...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('setting', function (Blueprint $table) {
            if (! Schema::hasColumn('setting', 'africa_map_version')) {
                $after = Schema::hasColumn('setting', 'nav_font_size') ? 'nav_font_size' : null;
                if ($after) {
                    $table->string('africa_map_version', 120)->nullable()->after($after);
                } else {
                    $table->string('africa_map_version', 120)->nullable();
                }
            }
    ...
    public function down(): void
    {
        ...
        Schema::table('setting', function (Blueprint $table) {
            foreach (['show_admin_units_map', 'africa_map_view_versions', 'africa_map_custom_versions', 'africa_map_version'] as $column) {
